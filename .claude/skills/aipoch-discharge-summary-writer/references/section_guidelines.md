...
### Examples
- ✅ "Intermittent chest pain for 3 days" / "Intermittent chest pain for 3 days"- ✅ "Fever and cough for 5 days" / "Fever and cough for 5 days"- ❌ "Patient feels unwell" (too vague)
...
## 2. Present Illness History Guidelines
...
### Example Structure
```
patient in3Chest pain without obvious cause days before...[timeline]  
The nature of the pain is...[Features]  
Then he went to the emergency department of our hospital...[Medical treatment process]  
Outpatient clinic is based on"coronary heart disease"Admission hospital...[Admission status]
```

## 3. Past Medical History Guidelines
### Include
...
### Example
```
Complete relevant examinations after the patient is admitted to hospital...[preliminary assessment]  
On admission day2Day trip...[operate/Operation]  
Postoperatively...[treat]  
Occurs during hospitalization...[complication/deal with]  
after treatment...[Efficacy evaluation]
```
...
### Format Example
```
1. Aspirin 100mg PO qd (antiplatelet，Long-term use)  
2. Atorvastatin 20mg PO qn (Lower blood lipids)  
3. Metoprolol 25mg PO bid (control heart rate)
```
...
- Cardiology outpatient follow-up consultation：After discharge1week，tuesday morning，Chief Physician Clinic
- carry information：Discharge summary、electrocardiogram、blood test report

### Activity guidance
- After discharge1Avoid strenuous exercise during the week
- Can carry out daily light activities

### dietary guidance
- Low salt and low fat diet
- Quit smoking and limit alcohol

### warning symptoms（Please seek medical attention immediately）
