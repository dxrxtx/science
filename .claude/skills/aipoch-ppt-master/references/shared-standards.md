...
<text x="100" y="200" font-size="24" fill="#333333">
 <tspan fill="#1A73E8" font-weight="bold">10</tspan>
</text>
```
...
```xml
<text x="100" y="200" font-size="24" fill="#333333"></text>
<text x="160" y="200" font-size="24" fill="#1A73E8" font-weight="bold">10</text>
<text x="240" y="200" font-size="24" fill="#333333"></text>
```
...
<text x="80" y="190" font-size="18" fill="#333333">
 <tspan x="80" dy="0">Complete<tspan fill="#4CAF50" font-weight="bold">98%</tspan></tspan>
 <tspan x="80" dy="35"><tspan fill="#F44336" font-weight="bold">¥120</tspan></tspan>
</text>
```
...
<text x="100" y="200" font-size="18" fill="#333333">
 <tspan x="100"></tspan><tspan x="600" font-weight="bold"></tspan>
</text>
```
...
- **Numerical results** — percentages, multipliers (`10x`), absolute amounts (`¥120`)
...
```xml
<text x="80" y="200" font-size="20" fill="#333333">
 2024<tspan fill="#1A73E8" font-weight="bold">35%</tspan><tspan fill="#1A73E8" font-weight="bold">12</tspan>
</text>
```
