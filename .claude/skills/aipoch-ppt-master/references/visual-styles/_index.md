...
| [`ink-wash`](./ink-wash.md) | Rice-paper whitespace, brush marks, seal accent, still | Cultural, philosophy, heritage, | `ink-notes` / `watercolor` |
...
| Photography-led / architecture / design / fashion / | `photo-editorial` | `editorial` |
| Data report / market review / / Bloomberg / Economist | `data-journalism` | `editorial` |
...
| Cultural / philosophy / heritage / / | `ink-wash` | `editorial` |
...
| Heritage / hospitality / retro brand / Font size / | `vintage-poster` | `zine` |
| Cultural / folk / festival / children / sustainability | `paper-cut` | `sketch-notes` |
| Education / training / onboarding / | `sketch-notes` | `paper-cut` |
| Methodology / before-after / manifesto / | `ink-notes` | `editorial` |
| Classroom / tutorial / academic / | `chalkboard` | `sketch-notes` |
