...
| Education / training / onboarding / | `sketch-notes` | `vector-illustration` (if school is corporate), `paper-cut` |
| Children / story / storybook / | `fantasy-animation` | `paper-cut`, `watercolor`, `sketch-notes` |
...
| Finance / data journalism / | `editorial` or `digital-dashboard` | `vector-illustration` |
...
| Gaming / retro / 8-bit / | `pixel-art` | `vintage-poster` |
