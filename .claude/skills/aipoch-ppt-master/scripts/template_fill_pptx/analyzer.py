...
THANKS_KEYWORDS = ("thank", "thanks", "q&a", "qa", "contact", "", "", "", "", "")
TOC_KEYWORDS = ("agenda", "contents", "content", "outline", "", "")
CHAPTER_KEYWORDS = ("chapter", "part", "section", "Section", "part")
...
def _slot_role(slot: dict[str, Any], order: int) -> str:
 ...
 y = geometry.get("y")
 if order == 1 or "title" in name or "Title" in name:
