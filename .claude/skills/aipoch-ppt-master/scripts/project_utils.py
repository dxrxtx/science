...
def get_project_info(project_path: str) -> Dict:
 ...
 spec_files = ['design_spec.md', 'DesignContent.md', 'design_specification.md', 'Design.md']
 ...
 legacy_source_file = project_path / '.md'
...
def find_all_projects(base_dir: str) -> List[Path]:
 ...
 ['design_spec.md', 'DesignContent.md', 'design_specification.md', 'Design.md'])
