...
def get_heading_level(size: float, size_map: dict, text: str = "",
 ...
 if not re.match(r'^[\d]+[.、Section]', text):
 return 0
...
def remove_page_footer(text: str) -> str:
 """
 Remove page number patterns from footers, e.g. 'November 2025 8' or '202511 8'.
 """
 ...
 # Chinese format: 202511 8
 pattern_cn = r'\s*\d{4}\d{1,2}\s+\d{1,3}\s*$'
