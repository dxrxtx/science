...
| User signal | Action |
|---|---|
| "set up brand" / "extract brand from this logo" / Brand / Brand | Run this workflow |
...
- Include the brand directory path in your initial Step 3 input — e.g. " Q4 PPT, skills/ppt-master/templates/brands/<brand_id>/ Brand"
