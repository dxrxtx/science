...
Skill           : automated-soap-note-generator
...
- [QS-2] Progressive Disclosure        : Body has 413 lines (>300), progressive disclosure recommended
...
- eval_report_automated-soap-note-generator_result.json — OVERWRITTEN (backup: ...pre-polish.bak)
