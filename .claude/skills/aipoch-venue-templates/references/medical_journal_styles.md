...
A comprehensive writing guide for NEJM, Lancet, JAMA, BMJ, Annals of Internal Medicine, and other major medical journals.
...
> "Every sentence should help a clinician make a better decision for their patient."

**Primary Goal**: To communicate research findings that improve patient care and clinical practice.
...
- Medical educators
- Select readers from public health and patient advocacy organizations
...
| **Patient-centered** | Focus on patient outcomes rather than just biomarkers |
| **Clinical** | Emphasis on practical applicability |
| **Precise** | Accurate numerical values, confidence intervals, NNT |
| **Measured** | Assertions must match the strength of the evidence |

### Voice

- **Passive voice is common**: "Patients were randomized to..."
- **First person is acceptable**: "We conducted a trial..."
- **Third person for patients**: Use "Patients" rather than "subjects"

---

## Abstracts: Structured Format

### Overview

Most major medical journals require a **structured abstract** with labeled sections. This is one of the few fields where structured abstracts are mandatory.

### Standard Structure (Based on IMRAD)

```
Background: [Why the study was needed - 1-2 sentences]

Methods: [Study design, setting, participants, interventions, primary outcome - 2-4 sentences]

Results: [Main and key secondary outcomes with statistical data - 3-5 sentences]

Conclusions: [Clinical implications with appropriate hedging - 1-2 sentences]
```

### Word Limits by Journal

| Journal | Abstract Word Limit |
|---------|---------------|
| NEJM | 250 words |
| Lancet | 300 words |
| JAMA | 350 words |
...
### Structured Abstract Example (NEJM Style)
...
**Phrasing must match the strength of the evidence.**

### Language Norms by Study Design

| Study Design | Appropriate Phrasing |
|-------------|---------------------|
...
| **Case-Control Study** | "Treatment X was associated with reduced odds of death..." |
| **Cross-Sectional Study** | "Treatment X use was associated with lower mortality..." |
...
❌ **Never say** (unless it's an RCT): "Treatment X prevents..." / "Treatment X causes..."

✅ **For observational studies**: "Treatment X was associated with..." / "Treatment X was linked to..."

✅ **For RCTs**: "Treatment X resulted in..." / "Treatment X reduced..."

### Hedging Phrases

| Level of Certainty | Phrases |
|----------------|---------|
...
**Always include 95% Confidence Intervals (CI).**
...
- Focus on the clinical problem and the rationale for the study
...
- What are the existing treatments/approaches?
- What evidence gaps remain?
- Why is more research needed?

**Paragraph 3: Rationale and Objectives**
- Why was this study conducted?
- Explicit statement of objectives/hypotheses
- Identification of the primary outcome measure
...
### Structure (Following CONSORT/STROBE)

The methods section in medical papers follows reporting standards:
...
**Eligibility Criteria**
- Clearly list inclusion and exclusion criteria
...
- Reference the CONSORT flow diagram
...
- Include point estimates, CIs, and P-values
...
**Adverse Events**
- Systematically report serious adverse events
- List deaths, hospitalizations, and SAEs by category
...
- Restate the primary outcome results
- State whether the hypothesis was supported

**Paragraphs 2-3: Interpretation and Context**
- How do findings compare with previous evidence?
- What are the possible mechanisms explaining the findings?
...
- Discuss how limitations affect the interpretation
...
- **References**: Usually ~40-50
- **Figures/Tables**: 4-5 total
- **Style**: Decisive, authoritative
- **Focus**: Major clinical trials, practice-changing research

### Lancet

- **Word Limit**: 3,500 words for research papers
- **Abstract**: 300 words, structured
- **Panels**: Use of panels to highlight key information
- **Research in Context**: Mandatory section explaining the contribution
- **Style**: Strong global health perspective

### JAMA (Journal of the American Medical Association)

- **Word Limit**: 3,000 words for original investigation
- **Abstract**: 350 words, structured
- **Key Points Box**: Required summary
- **Visual Abstracts**: Encouraged
...
- **Clinical Trials and Meta-analyses**: A specialty area
...
- Participant flow (Flow diagram mandatory)
...
**30 items** for studies of diagnostic accuracy
...
1. **Overclaiming Causality**: Using "caused" with observational data.
2. **Providing Only Relative Risk**: Failing to report absolute measures.
3. **Missing CIs**: Reporting point estimates without uncertainty ranges.
4. **Vague Limitations**: Saying "the study had limitations" without being specific.
5. **Ignoring Negative Results**: Selective reporting of outcomes.
6. **Confusing Clinical Significance**: Statistical significance does not equal clinical importance.
7. **Subgroup Mining**: Presenting post-hoc subgroup analyses as confirmatory.
...
### Essential Elements
- [ ] Structured abstract (matching journal-specific format)
- [ ] Trial registration number (for RCTs)
- [ ] Ethics committee approval statement
- [ ] Conflict of interest disclosure
- [ ] Completed CONSORT/STROBE checklist
...
- [ ] NNT calculated for clinically significant outcomes

### Evidence Language
- [ ] Assertions match study design
- [ ] Appropriate hedging used
- [ ] Causal language used only for RCTs
...
- `venue_writing_styles.md` - Overview of writing styles
- `journals_formatting.md` - Technical formatting requirements
- `reviewer_expectations.md` - What medical reviewers look for
