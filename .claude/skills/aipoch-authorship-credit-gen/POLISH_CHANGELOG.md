...
- [QS-2] Progressive Disclosure        : Body has 314 lines (>300), progressive disclosure recommended
...
- eval_report_authorship-credit-gen_result.json — OVERWRITTEN (backup: ...pre-polish.bak)
