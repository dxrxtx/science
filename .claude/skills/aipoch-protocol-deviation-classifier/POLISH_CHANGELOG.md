...
- [QS-2] Progressive Disclosure        : Body has 350 lines (>300), progressive disclosure recommended
...
- eval_report_protocol-deviation-classifier_result.json — OVERWRITTEN (backup: ...pre-polish.bak)
