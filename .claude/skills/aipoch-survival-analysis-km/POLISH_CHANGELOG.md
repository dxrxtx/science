...
- [QS-2] Progressive Disclosure        : Body has 316 lines (>300), progressive disclosure recommended
...
- eval_report_survival-analysis-km_result.json — OVERWRITTEN (backup: ...pre-polish.bak)
